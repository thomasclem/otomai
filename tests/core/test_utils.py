...
def test_calculate_take_profit_price(price, order_side, take_profit_pct, leverage, expected_tp):
...
def test_calculate_stop_loss_price(price, order_side, stop_loss_pct, leverage, expected_sl):
